...
HD_PWD='D:/onedrive/WSU/EE214/decoder/decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoding.vdi -applog -m64 -messageDb vivado.pb -mode batch -source decoding.tcl -notrace
