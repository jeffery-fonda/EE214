...
HD_PWD='D:/onedrive/WSU/EE214/shifter/shifter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shifty.vdi -applog -m64 -messageDb vivado.pb -mode batch -source shifty.tcl -notrace
