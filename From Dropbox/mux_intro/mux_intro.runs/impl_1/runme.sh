...
HD_PWD='D:/onedrive/WSU/EE214/mux_intro/mux_intro.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_intro.vdi -applog -m64 -messageDb vivado.pb -mode batch -source mux_intro.tcl -notrace
