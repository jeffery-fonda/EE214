...
HD_PWD='D:/onedrive/WSU/EE214/mux_intro/mux_intro.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_intro.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mux_intro.tcl
