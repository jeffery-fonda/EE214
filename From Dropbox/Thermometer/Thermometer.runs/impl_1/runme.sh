...
HD_PWD='D:/onedrive/WSU/EE214/Thermometer/Thermometer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TempLogic.vdi -applog -m64 -messageDb vivado.pb -mode batch -source TempLogic.tcl -notrace
