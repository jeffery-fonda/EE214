...
HD_PWD='D:/onedrive/WSU/EE214/Thermometer/Thermometer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TempLogic.vds -m64 -mode batch -messageDb vivado.pb -notrace -source TempLogic.tcl
