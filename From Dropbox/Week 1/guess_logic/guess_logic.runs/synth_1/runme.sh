...
HD_PWD='D:/onedrive/WSU/EE214/Week 1/guess_logic/guess_logic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logicSource.vds -m64 -mode batch -messageDb vivado.pb -notrace -source logicSource.tcl
