...
HD_PWD='D:/onedrive/WSU/EE214/Week 1/guess_logic/guess_logic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log logicSource.vdi -applog -m64 -messageDb vivado.pb -mode batch -source logicSource.tcl -notrace
