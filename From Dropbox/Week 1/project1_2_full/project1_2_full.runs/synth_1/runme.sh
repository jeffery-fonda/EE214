...
HD_PWD='D:/onedrive/WSU/EE214/Week 1/project1_2_full/project1_2_full.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiswitch.vds -m64 -mode batch -messageDb vivado.pb -notrace -source multiswitch.tcl
