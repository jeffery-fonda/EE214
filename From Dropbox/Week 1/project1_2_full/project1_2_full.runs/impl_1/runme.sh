...
HD_PWD='D:/onedrive/WSU/EE214/Week 1/project1_2_full/project1_2_full.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiswitch.vdi -applog -m64 -messageDb vivado.pb -mode batch -source multiswitch.tcl -notrace
