...
HD_PWD='D:/onedrive/WSU/EE214/Week 1/MultiSwitchLight/MultiSwitchLight.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Logic.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Logic.tcl
