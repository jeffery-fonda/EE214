...
HD_PWD='D:/onedrive/WSU/EE214/Week 1/MultiSwitchLight/MultiSwitchLight.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Logic.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Logic.tcl -notrace
