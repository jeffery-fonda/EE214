...
HD_PWD='D:/onedrive/WSU/EE214/Week 1/challenge_1_1/challenge_1_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fig_control.vdi -applog -m64 -messageDb vivado.pb -mode batch -source fig_control.tcl -notrace
