...
HD_PWD='D:/onedrive/WSU/EE214/challenge_1_1/challenge_1_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fig_control.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fig_control.tcl
