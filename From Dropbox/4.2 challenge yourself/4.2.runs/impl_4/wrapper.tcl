...
set rc [catch {
  ...
  set_property ip_repo_paths {{c:/Users/Garrett/Desktop/4.2 challenge yourself/4.2.cache/ip}} [current_project]
  set_property ip_output_repo {{c:/Users/Garrett/Desktop/4.2 challenge yourself/4.2.cache/ip}} [current_project]
  add_files -quiet {{C:/Users/Garrett/Desktop/4.2 challenge yourself/4.2.runs/synth_4/wrapper.dcp}}
...
set rc [catch {
  ...
  report_power -file wrapper_power_routed.rpt -pb wrapper_power_summary_routed.pb
