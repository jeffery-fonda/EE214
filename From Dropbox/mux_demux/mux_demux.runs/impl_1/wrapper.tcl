...
set rc [catch {
  ...
  set_property ip_repo_paths d:/onedrive/WSU/EE214/mux_demux/mux_demux.cache/ip [current_project]
  set_property ip_output_repo d:/onedrive/WSU/EE214/mux_demux/mux_demux.cache/ip [current_project]
  add_files -quiet D:/onedrive/WSU/EE214/mux_demux/mux_demux.runs/synth_1/wrapper.dcp
