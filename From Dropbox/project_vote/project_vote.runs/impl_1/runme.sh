...
HD_PWD='D:/onedrive/WSU/EE214/project_vote/project_vote.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log major5.vdi -applog -m64 -messageDb vivado.pb -mode batch -source major5.tcl -notrace
