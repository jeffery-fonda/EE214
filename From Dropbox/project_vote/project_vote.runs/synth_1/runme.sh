...
HD_PWD='D:/onedrive/WSU/EE214/project_vote/project_vote.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log major5.vds -m64 -mode batch -messageDb vivado.pb -notrace -source major5.tcl
