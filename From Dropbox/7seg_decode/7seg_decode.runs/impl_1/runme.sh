...
HD_PWD='D:/onedrive/WSU/EE214/7seg_decode/7seg_decode.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log num1.vdi -applog -m64 -messageDb vivado.pb -mode batch -source num1.tcl -notrace
