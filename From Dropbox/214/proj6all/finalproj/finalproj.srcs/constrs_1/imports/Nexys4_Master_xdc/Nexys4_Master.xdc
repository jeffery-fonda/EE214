...
set_property PACKAGE_PIN L3 [get_ports {C[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {C[0]}]
##Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {C[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {C[1]}]
##Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {C[2]}]					
...
set_property PACKAGE_PIN K3 [get_ports {C[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {C[4]}]
##Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {C[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {C[5]}]
##Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {C[6]}]					
...
set_property PACKAGE_PIN N6 [get_ports {an[0]}]					
	2set_property IOSTANDARD LVCMOS33 [get_ports {an[0]}]
...
set_property PACKAGE_PIN E16 [get_ports inc]						
