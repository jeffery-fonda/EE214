...
HD_PWD='C:/Users/aswan_000/Desktop/ee214/project 4/challenge #2/challenge #2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log segments.vds -m64 -mode batch -messageDb vivado.pb -notrace -source segments.tcl
