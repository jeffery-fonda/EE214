...
HD_PWD='D:/onedrive/WSU/EE214/prio_encode/prio_encode.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prio_encode_logic.vds -m64 -mode batch -messageDb vivado.pb -notrace -source prio_encode_logic.tcl
