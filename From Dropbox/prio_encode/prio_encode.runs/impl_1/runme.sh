...
HD_PWD='D:/onedrive/WSU/EE214/prio_encode/prio_encode.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log prio_encode_logic.vdi -applog -m64 -messageDb vivado.pb -mode batch -source prio_encode_logic.tcl -notrace
