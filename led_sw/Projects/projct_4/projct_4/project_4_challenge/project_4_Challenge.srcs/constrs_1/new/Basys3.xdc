...
set_property PACKAGE_PIN W15 [get_ports {sw1[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw1[0]}]
set_property PACKAGE_PIN V15 [get_ports {sw1[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw1[1]}]
set_property PACKAGE_PIN W14 [get_ports {sw1[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw1[2]}]
set_property PACKAGE_PIN W13 [get_ports {sw1[3]}]					
